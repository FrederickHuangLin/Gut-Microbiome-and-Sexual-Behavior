...
p_summ_prim = df_fig %>% 
  ...
  scale_y_continuous(breaks = c(0, 20, 40, 60, 80, 100), limits = c(0, 120)) + 
  geom_text(aes(x = 3.5, y = 115, label = lab)) +
...
```{r}
ggsave(filename = "../results/figures/supp_expose.pdf", plot = p_expose,
